...
-- Last modification date: 2024-10-10 21:22:44.558
...
CREATE TABLE PROYECTO (
    ID bigint  NOT NULL AUTO_INCREMENT,
    NOMBRE char(255)  NOT NULL,encargado_proyecto
    DESCRIPCION varchar(500)  NOT NULL,
...
-- Reference: ALMACEN_PROYECTO (table: ALMACEN)
ALTER TABLE ALMACEN ADD CONSTRAINT ALMACEN_PROYECTO FOREIGN KEY ALMACEN_PROYECTO (PROYECTO_ID)
