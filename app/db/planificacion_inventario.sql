...
ALTER TABLE COMPRA_MATERIAL ADD CONSTRAINT COMPRA_MATERIAL_PROVEEDOR FOREIGN KEY COMPRA_MATERIAL_PROVEEDOR (PROVEEDOR_ID)
    REFERENCES PROVEEDOR (ID);

-- Reference: COMPRA_PROVEEDOR (table: COMPRA_HERRAMIENTA)
ALTER TABLE COMPRA_HERRAMIENTA ADD CONSTRAINT COMPRA_PROVEEDOR FOREIGN KEY COMPRA_PROVEEDOR (PROVEEDOR_ID)
    REFERENCES PROVEEDOR (ID);

-- Reference: DETALLE_COMPRA_HERRAMIENTA_COMPRA_HERRAMIENTA (table: DETALLE_COMPRA_HERRAMIENTA)
ALTER TABLE DETALLE_COMPRA_HERRAMIENTA ADD CONSTRAINT DETALLE_COMPRA_HERRAMIENTA_COMPRA_HERRAMIENTA FOREIGN KEY DETALLE_COMPRA_HERRAMIENTA_COMPRA_HERRAMIENTA (COMPRA_HERRAMIENTA_ID)
    REFERENCES COMPRA_HERRAMIENTA (ID);

-- Reference: DETALLE_COMPRA_HERRAMIENTA_HERRAMIENTA (table: DETALLE_COMPRA_HERRAMIENTA)
ALTER TABLE DETALLE_COMPRA_HERRAMIENTA ADD CONSTRAINT DETALLE_COMPRA_HERRAMIENTA_HERRAMIENTA FOREIGN KEY DETALLE_COMPRA_HERRAMIENTA_HERRAMIENTA (HERRAMIENTA_ID)
    REFERENCES HERRAMIENTA (ID);

-- Reference: DETALLE_COMPRA_MATERIAL_COMPRA_MATERIAL (table: DETALLE_COMPRA_MATERIAL)
ALTER TABLE DETALLE_COMPRA_MATERIAL ADD CONSTRAINT DETALLE_COMPRA_MATERIAL_COMPRA_MATERIAL FOREIGN KEY DETALLE_COMPRA_MATERIAL_COMPRA_MATERIAL (COMPRA_MATERIAL_ID)
    REFERENCES COMPRA_MATERIAL (ID);

-- Reference: DETALLE_COMPRA_MATERIAL_MATERIAL (table: DETALLE_COMPRA_MATERIAL)
ALTER TABLE DETALLE_COMPRA_MATERIAL ADD CONSTRAINT DETALLE_COMPRA_MATERIAL_MATERIAL FOREIGN KEY DETALLE_COMPRA_MATERIAL_MATERIAL (MATERIAL_ID)
